...
public class CountdownPanel extends BubbaPanel implements ActionListener {
	...
	public CountdownPanel(GuiClient client, GuiController controller) {
		...
		this.clockLabel.setFont(this.clockLabel.getFont().deriveFont(48.0f));
		this.add(this.clockLabel, constraints);
	...
	private class SetTimerDialog extends BubbaDialogPanel {
		...
		public SetTimerDialog(BubbaGuiController controller) {
			...
			int currentMin = CountdownPanel.this.timerLength / 600;
			int currentSec = ( CountdownPanel.this.timerLength - ( 600 * currentMin ) ) / 10;
		...
		public void windowClosed(WindowEvent event) {
			...
			if (option == JOptionPane.OK_OPTION) {
				CountdownPanel.this.timerLength = (int) this.minSpinner.getValue() * 600
						+ (int) this.secSpinner.getValue() * 10;
				CountdownPanel.this.resetTimer();
			}
		}
