...
public class Game implements Serializable {
	...
	public enum Technology {
		...
		ADVANCED_MILITARY("Advanced Military", new ArrayList<Type>() {
			private static final long serialVersionUID = 543488111062214027L;

			{
				add(Type.CIVICS);
			}
		}, 240, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = 543488111062214027L;
		...
		AGRICULTURE("Agriculture", new ArrayList<Type>() {
			private static final long serialVersionUID = 4537011915744500590L;

			{
				add(Type.CRAFTS);
			}
		}, 120, new HashMap<Type, Integer>() {
		...
		ARCHITECHTURE("Architechture", new ArrayList<Type>() {
			private static final long serialVersionUID = 666701458904134122L;

			{
				add(Type.ARTS);
			}
		}, 140, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = 7031037930756667181L;
		...
		ASTRONAVIGATION("Astronavigation", new ArrayList<Type>() {
			private static final long serialVersionUID = -7541771179129766109L;

			{
				add(Type.SCIENCE);
			}
		}, 80, new HashMap<Type, Integer>() {
		...
		CALENDAR("Calendar", new ArrayList<Type>() {
			private static final long serialVersionUID = 2775690088569515817L;

			{
				add(Type.SCIENCE);
			}
		}, 180, new HashMap<Type, Integer>() {
		...
		CARTOGRAPHY("Cartography", new ArrayList<Type>() {
			private static final long serialVersionUID = -2089788045159380055L;

			{
				add(Type.SCIENCE);
			}
		}, 160, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = -7541771179129766109L;
		...
		CLOTH_MAKING("Cloth Making", new ArrayList<Type>() {
			private static final long serialVersionUID = -4927290471028918556L;

			{
				add(Type.CRAFTS);
			}
		}, 50, new HashMap<Type, Integer>() {
		...
		CULTURAL_ASCENDANCY("Cultural Ascendancy", new ArrayList<Type>() {
			private static final long serialVersionUID = 1917499061422154540L;

			{
				add(Type.ARTS);
			}
		}, 280, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = -2089788045159380055L;
		...
		DEMOCRACY("Democracy", new ArrayList<Type>() {
			private static final long serialVersionUID = -8961620213522975422L;

			{
				add(Type.CIVICS);
			}
		}, 220, new HashMap<Type, Integer>() {
		...
		DIASPORA("Diaspora", new ArrayList<Type>() {
		...
		DIPLOMACY("Diplomacy", new ArrayList<Type>() {
		...
		DRAMA_AND_POETRY("Drama and Poetry", new ArrayList<Type>() {
		...
		EMPIRICISM("Empiricism", new ArrayList<Type>() {
			private static final long serialVersionUID = 1791410751966280831L;

			{
				add(Type.CIVICS);
			}
		}, 60, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = -2440070450841210384L;
		...
		ENGINEERING("Engineering", new ArrayList<Type>() {
		...
		ENLIGHTENMENT("Enlightenment", new ArrayList<Type>() {
		...
		FUNDAMENTALISM("Fundamental", new ArrayList<Type>() {
			private static final long serialVersionUID = 1554440447155252840L;

			{
				add(Type.RELIGION);
			}
		}, 150, new HashMap<Type, Integer>() {
			private static final long serialVersionUID = -3633799324062178157L;
		...
		LIBRARY("Library", new ArrayList<Type>() {
		...
		LITERACY("Literacy", new ArrayList<Type>() {
		...
		MASONRY("Masonry", new ArrayList<Type>() {
		...
		MATHEMATICS("Mathematics", new ArrayList<Type>() {
		...
		MEDICINE("Medicine", new ArrayList<Type>() {
		...
		METALWORKING("Metalworking", new ArrayList<Type>() {
		...
		MILITARY("Military", new ArrayList<Type>() {
			private static final long serialVersionUID = -4006498687693613256L;

			{
				add(Type.CIVICS);
			}
		}, 170, new HashMap<Type, Integer>() {
		...
		MONARCHY("Monarchy", new ArrayList<Type>() {
		...
		MONOTHEISM("Montheism", new ArrayList<Type>() {
		...
		MONUMENT("Monument", new ArrayList<Type>() {
		...
		MUSIC("Music", new ArrayList<Type>() {
		...
		MYSTICISM("Mysticism", new ArrayList<Type>() {
		...
		MYTHOLOGY("Mythology", new ArrayList<Type>() {
		...
		NAVAL_WARFARE("Naval Warfare", new ArrayList<Type>() {
		...
		PHILOSOPHY("Philosophy", new ArrayList<Type>() {
		...
		POLITICS("Politics", new ArrayList<Type>() {
		...
		POTTERY("Pottery", new ArrayList<Type>() {
		...
		PROVINCIAL_EMPIRE("Provincial Empire", new ArrayList<Type>() {
			private static final long serialVersionUID = -441460963738213208L;

			{
				add(Type.CIVICS);
			}
		}, 260, new HashMap<Type, Integer>() {
		...
		PUBLIC_WORKS("Public Works", new ArrayList<Type>() {
		...
		RHETORIC("Rhetoric", new ArrayList<Type>() {
			private static final long serialVersionUID = 3994229895436249390L;

			{
				add(Type.ARTS);
			}
		}, 130, new HashMap<Type, Integer>() {
		...
		ROADBUILDING("Roadbuilding", new ArrayList<Type>() {
		...
		SCULPTURE("Sculpture", new ArrayList<Type>() {
		...
		THEOCRACY("Theocracy", new ArrayList<Type>() {
		...
		THEOLOGY("Theology", new ArrayList<Type>() {
		...
		TRADE_EMPIRE("Trade Empire", new ArrayList<Type>() {
		...
		TRADE_ROUTES("Trade Routes", new ArrayList<Type>() {
		...
		UNIVERSAL_DOCTRINE("Universal Doctrine", new ArrayList<Type>() {
		...
		URBANISM("Urbanism", new ArrayList<Type>() {
		...
		WONDER_OF_THE_WORLD("Wonder of the World", new ArrayList<Type>() {
		...
		WRITTEN_RECORD("Written Record", new ArrayList<Type>() {
			/**
			 * 
			 */
		...
		Technology(String name, ArrayList<Type> types, int baseCost, HashMap<Type, Integer> typeCredits,
				HashMap<Technology, Integer> techCredits, String text) {
			this.name = name;
			this.types = types;
